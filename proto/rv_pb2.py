...
_FILEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='sha256', full_name='rv.proto.FileRequest.sha256', index=1,
