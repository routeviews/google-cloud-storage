	...
	}{
		{
			...
			want: &update{
				...
				Attributes: map[bgp.BGPAttrType]bgp.PathAttributeInterface{
					bgp.BGP_ATTR_TYPE_AS_PATH: bgp.NewPathAttributeAsPath([]bgp.AsPathParamInterface{
		...
		},
		{
			...
			want: &update{
				...
				Announced: []*bgp.IPAddrPrefix{bgp.NewIPAddrPrefix(24, "30.0.0.0"),
					bgp.NewIPAddrPrefix(24, "40.0.0.0")},
				Attributes: map[bgp.BGPAttrType]bgp.PathAttributeInterface{
					bgp.BGP_ATTR_TYPE_AS4_PATH: bgp.NewPathAttributeAs4Path(
						[]*bgp.As4PathParam{{Type: bgp.BGP_ASPATH_ATTR_TYPE_SEQ, Num: 1, AS: []uint32{100000}}}),
					bgp.BGP_ATTR_TYPE_AS_PATH: bgp.NewPathAttributeAsPath(
